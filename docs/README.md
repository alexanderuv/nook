...
| [07](./07-document-templates.md) | Document templates | The artifact catalog — eleven templated types: ten across frame/discover/define/decide/build/learn plus the project-level architecture overview (orient) — and its menu principle; section *content* stays development-time | **Settled** |
