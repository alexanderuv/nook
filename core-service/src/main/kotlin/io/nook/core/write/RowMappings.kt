...
// Rows to contract entities. An unknown stored code is a corrupted store, not
// a caller error — this service is the single writer and never stores one —
// so it fails loudly instead of mapping to anything.
